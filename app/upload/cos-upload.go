...
func RunCos(ctx *gin.Context) {
	...
	for _, file := range files {
		if fileUrl, err = putObjectByCos(file); err != nil {
...
// putObjectByCos 上传文件到腾讯云对象存储
func putObjectByCos(file *multipart.FileHeader) (signedURL string, err error) {
